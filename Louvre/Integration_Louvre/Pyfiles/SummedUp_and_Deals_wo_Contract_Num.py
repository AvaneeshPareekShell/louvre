...
writeLouvreDbTable(summed_up_final,"louvre_curated.Summed_up_on_Contract_Item")

# COMMAND ----------

writeLouvreDbTable(deals_wo_contract_num,"louvre_curated.deals_wo_contract_num")
